...
module.exports = {
   ...
   // String Values
   SESSION_ID: process.env.SESSION_ID || "Session~pqT97M7Z", // Put your session
   HANDLERS: process.env.HANDLER === "false" || process.env.HANDLER === "null" ? "^" : "[.]",
   BOT_INFO: process.env.BOT_INFO || "JORES FALCAO BUSINESS;KᴇʀᴍLɪᴛᴇ⚡️", // YourName;BotName;Image/VideoLink
   SUDO: process.env.SUDO || "237620732056",
